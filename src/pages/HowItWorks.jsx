  ...
  return (
    <div className='bg-[#eccec7]'>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <ol className='flex flex-col text-center w-full'>
          <li className='bg-secondary flex flex-col lg:flex-row lg:justify-center lg:items-center p-4 gap-4'>
          ...
          <li className='bg-secondary flex flex-col lg:flex-row-reverse lg:justify-center lg:items-center p-4 gap-2'>
            <div className='lg:px-24'>
              <h3 className='font-display text-xl lg:text-3xl pb-4'>
