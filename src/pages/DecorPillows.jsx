    ...
    <div>
      ...
      <div className='bg-[#F3F0EB] hidden lg:flex justify-center py-4'>
        <ul className='flex justify-center items-center gap-x-7'>
          <Link
            to='/react-mcm-interior-design/furniture'
            className='font-body text-lg px-10'
          >
            Furniture
          </Link>
          <Link
            to='/react-mcm-interior-design/decor-pillows'
            className='font-body text-lg px-10'
          >
            Decor & Pillows
          </Link>
          <Link
            to='/react-mcm-interior-design/lighting'
            className='font-body text-lg px-10'
          >
            Lighting
          </Link>
      ...
      <div>
        <div className='bg-secondary xl:bg-background w-full flex justify-center gap-x-5 xl:justify-end xl:pr-10 py-4'>
          <Button
            text='Color'
            className='bg-slate-300 hover:bg-slate-400 font-body xl:hidden'
          />
          <Button
            text='Product'
            className='bg-slate-300 hover:bg-slate-400 font-body xl:hidden'
          ...
          <Button
            text='Sort By'
            className='bg-slate-300 hover:bg-slate-400 font-body'
          />
        </div>
        <div>
          <div className='flex gap-x-5'>
            <div className='bg-secondary hidden p-4 xl:flex flex-col w-1/4 h-fit rounded-lg'>
              <div className='mb-10'>
                ...
                <div
                  className={
                    products ? "flex flex-col font-body pl-4 pt-5" : "hidden"
                  }
                >
                  <label>
                    <input
              ...
              <div>
                ...
                <div
                  className={
                    colors ? "flex flex-col font-body pl-4 pt-5" : "hidden"
                  }
                >
                  <label>
                    <input
