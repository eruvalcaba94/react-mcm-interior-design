    ...
    <div>
      ...
      <div>
        ...
        {productReviews.map(review => (
          <div key={review.id} className='flex flex-col lg:flex-row mx-5 lg:mx-20 border-b border-b-black'>
            ...
            <div className='flex flex-col w-full lg:px-10'>
              <p className='font-body text-xs text py-2 lg:py-5'>{review.dateCreated}</p>
      ...
      <div className='flex justify-center items-center pt-5 pb-10'>
        <Button text="Leave A Review" className="bg-[#f55d42] hover:bg-[#da4c33] text-secondary text-3xl font-display" />
      </div>
      <Footer />
    </div>
  );
