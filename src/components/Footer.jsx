    ...
    <div className='bg-accent w-full h-auto'>
      <div className='hidden lg:flex justify-between items-start w-auto pt-16 px-4 lg:px-20 xl:px-28 2xl:px-40  pb-10'>
        ...
        <div className='max-w-sm'>
          ...
          <p className='font-body text-lg'>
            We're committed to your satisfaction. From handpicked mid-century
            modern furniture to personalized design guidance, we prioritize
            quality and timeless style. We work closely with you to create a
            space that reflects your unique vision.
          </p>
        </div>
      </div>
      <div className='flex lg:hidden flex-col w-full pt-7 px-5 pb-14'>
        ...
        <div>
          ...
          <ul className={explore ? "font-body p-3" : "hidden"}>
            <li className='mb-2'>Financing</li>
            <li className='mb-2'>Help Center</li>
        ...
        <div>
          <div>
            ...
            <ul className={contact ? "font-body p-3" : "hidden"}>
              <li className='mb-2'>Call</li>
              <li className='mb-2'>Text</li>
              <li className='mb-2'>Email</li>
            </ul>
